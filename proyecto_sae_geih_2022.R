...
#head(auxiliar_out)
#auxiliar_out$eblup = eblup1$fit$estcoef$beta[1]+eblup1$fit$estcoef$beta[2]*auxiliar_out$TOTAL_PET #+ eblup1$fit$estcoef$beta[3]*auxiliar_out$PORC_PET 
